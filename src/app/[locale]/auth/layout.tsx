...
export default function AuthLayout({children}: Readonly<{ children: React.ReactNode }>) {
  const [overlayClass] = useState<boolean>(false);
  ...
  return (
    <div
      ...
      <main className="md:pt-[98px] pb-4 min-h-[100vh] max-w-[100vw] flex justify-center bg-auth-pattern bg-no-repeat bg-[left_bottom_6rem]">
        {children}
      </main>
    </div>
  );
